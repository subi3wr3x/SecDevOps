...
# Purpose    :   Check SMTP servers
#                and save a history
#
# Submit as
#
#         #Monitor_smtp.sh
#         0,5,10,15,20,25,30,35,40,45,50,55 * * * * /usr/local/admin/bin/monitor_smtp.sh
#
...
SMTP_CONF_FILE="$WEBROOT/smtpmon/conf/monitor_smtp.conf"
source $SMTP_CONF_FILE
...
[[ -e $SMTP_CONF_FILE  ]]    || { echo SMTP_CONF_FILE: $SMTP_CONF_FILE      does not exist ; exit 1; }
